...
public class Demo {
	...
	public void fun6() throws Exception{
		...
		String name = (String) Ognl.getValue("@cn.tao.a_ognl.HahaUtils@echo('hello 强勇!')", oc, oc.getRoot());
	...
	public void fun7() throws Exception{
		...
		System.out.println(name2);*/
		//创建Map对象
		Integer size2 = (Integer) Ognl.getValue("#{'name':'tom','age':18}.size()", oc, oc.getRoot());//#号表示创建map
